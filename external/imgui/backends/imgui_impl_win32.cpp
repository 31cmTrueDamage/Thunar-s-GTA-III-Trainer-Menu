...
#define IMGUI_IMPL_WIN32_DISABLE_DWM
#include "imgui.h"
...
{
    // GTA 3 is 32-bit and does not need DWM/Aero blur.
    // This function does nothing on MinGW-w64.
    (void)hwnd; // avoid unused parameter warning
}
